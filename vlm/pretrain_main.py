...
from models.event_clr import build_model
...
from data.dataset import build_contrastive_dataset
from utils.config_parser import build_config_parser
from data.pretrain_dataloader import build_dataloader
...
def main(rank: int,
    ...
    parser = build_config_parser(config_file_path='configs/pretrain_config.yaml')
    ...
    train_dataset, val_dataset = build_contrastive_dataset(config=config,
    ...
    # Train the model
    pretrainer = Pretrainer(model=model,
                            optimizer=optimizer,
                            objective=objective,
                            scheduler=scheduler,
                            logger=logger,
    ...
    pretrainer.pretrain(train_dataloader=train_dataloader,
